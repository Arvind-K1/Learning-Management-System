                ...
                <div className="flex items-center gap-5 mx-10">
                    <section className="w-1/2 space-y-10">
                        ...
                        <p className="text-xl text-gray-200">
                            Our goal is to provide the affordable and quality education to the world. We are provinding the platform for the aspiring teachers and students to share their skills, creativity and knowledge to each other to empower and contribute in the growth and wellness of mankind.
                        </p>
                    </section>
                    <div className="w-1/2">
                        <img src={aboutMainPage} className="drop-shadow-2xl" alt="about main page" />
                    </div>
                </div>
                ...
                <div className="carousel w-1/2 my-10 mx-auto">
                    ...
                    <div id="slide4" className="carousel-item relative w-full">
                        <div className="flex flex-col items-center justify-center gap-4 px-[15%]">
                            ...
                            <p className="text-xl text-gray-200">Success is a lousy teacher. It seduces smart people inot thinking they can't lose.</p>
